...
(() => {
    ...
    const colors = ["purple", "blessed", "yellow", "gigglyfuneclown", "red", "blue", "green", "pink", "brown", "orange", "black", "jew", "cyan", "white", "king", "pope", "rabbi", "peedy", "clippy", "troll", "jabba", "spadezi", "raging"];
